...
rom_ob_truth = groundtruth %>% 
  filter(File_id == "2012-10-22.txt")
write.csv(rom_ob_truth, 'rom_ob_truth.csv', row.names=FALSE)
```
...
<<<<<<< HEAD
```{r}
rom_ob_entire <- full_join(rom_ob_crowd, rom_ob_truth, join_by = Sentence_id)
write.csv(rom_ob_entire, 'rom_ob.csv', row.names=FALSE)
=======
...
>>>>>>> 1007573a79b8f076b2cfbc0124697af55e641cfa
```
